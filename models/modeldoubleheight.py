...
class STBVMM(nn.Module):
    ...
    def forward(self, stacked_input, amp, c=None):
        # Assuming 'stacked_input' is of shape (batch_size, 3, 2H, W)
        # We split them along the height dimension
        a, b = torch.split(stacked_input, stacked_input.shape[2] // 2,
                           dim=2)  # New shape for each: (batch_size, 3, H, W)
