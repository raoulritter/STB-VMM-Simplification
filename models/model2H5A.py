...
class STBVMM(nn.Module):
    ...
    def forward(self, x, c=None):
        # Split the input tensor into two images
        a, b = torch.split(x, x.shape[2] // 2, dim=2)

        # Set the amplitude to a fixed value
        amp = torch.tensor(5.0).to(a.device)
...
if __name__ == '__main__':
    ...
    stacked = torch.randn((1, 3, 768, 384))
